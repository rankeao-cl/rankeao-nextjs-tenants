    ...
    return (
      <div className="space-y-6">
        {Array.from({ length: 2 }).map((_, i) => (
          <Card key={i} className="bg-[var(--card)] border border-[var(--border)] p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1.5"><Skeleton className="h-4 w-20 rounded" /><Skeleton className="h-10 w-full" /></div>
              <div className="space-y-1.5"><Skeleton className="h-4 w-24 rounded" /><Skeleton className="h-10 w-full" /></div>
            </div>
      ...
      <Card className="bg-[var(--card)] border border-[var(--border)] p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-[var(--muted-foreground)] text-sm">Permite a los clientes pagar depositando directamente en tu cuenta.</p>
          </div>
          <div className="flex items-center gap-3">
            <span className="text-xs text-[var(--muted-foreground)]">{transferMethod?.is_active ? "Activado" : "Desactivado"}</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <Label className="text-sm text-[var(--muted-foreground)] mb-1.5 block">Banco</Label>
          ...
          <div>
            <Label className="text-sm text-[var(--muted-foreground)] mb-1.5 block">Tipo de Cuenta</Label>
          ...
          <div>
            <Label className="text-sm text-[var(--muted-foreground)] mb-1.5 block">Número de Cuenta</Label>
          ...
          <div>
            <Label className="text-sm text-[var(--muted-foreground)] mb-1.5 block">RUT / Identificación</Label>
          ...
          <div className="md:col-span-2">
            <Label className="text-sm text-[var(--muted-foreground)] mb-1.5 block">Correo Electrónico para Comprobantes</Label>
      ...
      <Card className="bg-[var(--card)] border border-[var(--border)] p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-[var(--muted-foreground)] text-sm">El cliente paga al momento de retirar su pedido en tienda.</p>
          </div>
          <div className="flex items-center gap-3">
            <span className="text-xs text-[var(--muted-foreground)]">{cashMethod?.is_active ? "Activado" : "Desactivado"}</span>
        ...
        <div>
          <Label className="text-sm text-[var(--muted-foreground)] mb-1.5 block">Instrucciones Adicionales (Opcional)</Label>
          <Textarea
